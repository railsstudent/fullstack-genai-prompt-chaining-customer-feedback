...
This repo uses NestJS, Langchain and Gemini 1.5 Pro model to build a backend application to generate ESG advisory feedback with prompt chaining.
...
| Name                  | Description                                           |
| --------------------- | ----------------------------------------------------- |
| PORT                  | Backend Port. Default to 3002                         |
